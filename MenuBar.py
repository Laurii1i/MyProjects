...
class MenuBar():
    ...
    def __init__(self, root):
        ...
        self.update_button = ctk.CTkButton(self.menu_frame, text = 'Päivitä Tietokanta', font = (menu_bar_font, menu_bar_font_size), width = menu_bar_button_width)
        self.update_button.grid(row = 0, column = 0, padx = menu_bar_button_pad)

        self.search_button = ctk.CTkButton(self.menu_frame, text = 'Etsi Tuotteita', font = (menu_bar_font, menu_bar_font_size), width = menu_bar_button_width)
        self.search_button.grid(row = 0, column = 1, padx = menu_bar_button_pad)

        self.show_basket_button = ctk.CTkButton(self.menu_frame, text = 'Luo Tarjous', font = (menu_bar_font, menu_bar_font_size), width = menu_bar_button_width)
