...
class MenuBar():
    ...
    def __init__(self, root):
        ...
        self.update_button = ctk.CTkButton(self.menu_frame, text = Translator.get_string('STR_UI_PAIVITA_TIETOKANTA'), font = (menu_bar_font, menu_bar_font_size), width = menu_bar_button_width)
