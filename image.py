...
class image():
    ...
    def __init__(self, frame, position, index, path, parent_layout, side_length, root, discount, product_data) -> None:
        ...
        self.label = tk.Label(self.frame, image=self.photo, bg= root.layout3_frame_color, width = side_length, height = side_length)
    ...
    def select_image(self, control_state):
        ...
        if not self.selected:
            ...
            self.label.configure(bg = self.root.layout3_highlight_color)  # background to light blue to indicate that
    ...
    def de_select_image(self):
        ...
        if self.selected:
            ...
            self.label.configure(bg = self.root.layout3_frame_color) # background to light yellow to indicate that
